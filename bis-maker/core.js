(function (root) {
  ...
  const DROP_SPECS = Object.freeze({
    ...
    raid_hands: Object.freeze({ label: "영식 손", status: "raid", gearSlots: Object.freeze(["hands"]) }),
    raid_legs: Object.freeze({ label: "영식 다리", status: "raid", gearSlots: Object.freeze(["legs"]) }),
    raid_feet: Object.freeze({ label: "영식 발", status: "raid", gearSlots: Object.freeze(["feet"]) }),
